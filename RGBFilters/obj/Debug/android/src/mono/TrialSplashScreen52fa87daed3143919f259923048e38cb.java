...
public class TrialSplashScreen52fa87daed3143919f259923048e38cb extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen52fa87daed3143919f259923048e38cb.this, rgbfilters.RGBfilters.class);
