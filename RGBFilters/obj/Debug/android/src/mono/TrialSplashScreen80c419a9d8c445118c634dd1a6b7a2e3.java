...
public class TrialSplashScreen80c419a9d8c445118c634dd1a6b7a2e3 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen80c419a9d8c445118c634dd1a6b7a2e3.this, rgbfilters.RGBfilters.class);
