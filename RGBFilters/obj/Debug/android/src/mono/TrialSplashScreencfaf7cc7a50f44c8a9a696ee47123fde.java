...
public class TrialSplashScreencfaf7cc7a50f44c8a9a696ee47123fde extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreencfaf7cc7a50f44c8a9a696ee47123fde.this, rgbfilters.RGBfilters.class);
