...
public class TrialSplashScreen7a1a6c7fee20432bbdc700db2386049e extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen7a1a6c7fee20432bbdc700db2386049e.this, rgbfilters.RGBfilters.class);
