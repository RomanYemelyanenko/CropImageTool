...
public class TrialSplashScreenf8a35d6e4fa24a1493debe0bd1f5dce7 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreenf8a35d6e4fa24a1493debe0bd1f5dce7.this, rgbfilters.RGBfilters.class);
