...
public class TrialSplashScreen731b906a8a9b48c9b9b50db50f23d04c extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen731b906a8a9b48c9b9b50db50f23d04c.this, rgbfilters.RGBfilters.class);
